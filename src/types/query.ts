...
export { fieldsParamSchema, sortParamSchema, limitParamSchema, offsetParamSchema, pageParamSchema, searchParamSchema };
...
export type LogicalFilterOR = { _or: z.infer<typeof filterSchema>[]; }
export type LogicalFilterAND = { _and: z.infer<typeof filterSchema>[]; }
